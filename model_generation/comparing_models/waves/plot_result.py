...
test_folder = 'test4xxxxxx'
out_dir = '../bilder/results/'
specific_folder = 'del2/test4xxxxxxxxxxxx'
dir = out_dir+specific_folder
testname = 'part2_test4xxxxxxxxxxxxxxx'
file_type = 'pdf'
start = 0
end = 50
print(dir)
...
files = [
    ...
    ("M3 (crane)", f"model_generation/comparing_models/waves/{test_folder}/M3.csv"),
