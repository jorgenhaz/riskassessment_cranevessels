...
from model_generation.models.M5.waves.wave_utils import jonswap_spectrum, dynamical_pressure_field, wave_accelerations
import yaml
...
with open('model_generation/models/M5/waves/wave_model_input.yaml', 'r') as file:
...
filepath_cpp = "../code/cpp_sim_testing/M5_wave/src"
filepath_h = "../code/cpp_sim_testing/M5_wave/include"
