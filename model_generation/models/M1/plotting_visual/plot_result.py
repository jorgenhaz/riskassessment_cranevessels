...
df = pd.read_csv("model_generation/models/model_5/plotting_visual/csv_files/gui_test_1.csv", index_col=False)
df_wave = pd.read_csv("model_generation/models/model_5/plotting_visual/csv_files/gui_test_2.csv", index_col=False)
