...
# Between CG and CB - simplification
...
"""_____Generating c++ code_____"""
# Filepaths
filepath_cpp_wave = "../code/cpp_sim_testing/M3_wave/src"
filepath_h_wave   = "../code/cpp_sim_testing/M3_wave/include"
filepath_cpp = "../code/cpp_sim_testing/M3/src"
filepath_h   = "../code/cpp_sim_testing/M3/include"
...
# with open ("../code/cpp_sim_testing/M3_wave/files/init.yaml", "w") as f:
#     for var in all_vars:
#         f.write(f"{var}: 0.0 \n")