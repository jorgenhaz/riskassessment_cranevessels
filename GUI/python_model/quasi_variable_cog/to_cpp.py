...
D_spat = Matrix.vstack(
            Matrix.hstack(Dv,         -Dv * S(r_boat_cog)),
            Matrix.hstack(Dv*S(r_boat_cog),  Dw)
         )
...
filepath_cpp = "cpp_gui/src"
filepath_h = "cpp_gui/include"
cppw.generate_cpp_files(B, 'mass_inertia', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(betta, 'beta', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(gamma_T_diff_omega, 'gamma_T_diff_omega', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(T_diff_q, 'T_diff_q', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(P_diff_q, 'P_diff_q', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(D_omega, 'D_q_dot', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(restoring_forces, 'restoring', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(B_A, 'B_added_mass', all_vars, filepath_cpp, filepath_h)
cppw.generate_cpp_files(C_A, 'C_added_mass', all_vars, filepath_cpp, filepath_h)
