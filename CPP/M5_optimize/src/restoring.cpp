...
Eigen::VectorXd restoring(Eigen::VectorXd kwargs) {
	...
	m8(1) = 0;
	m8(2) = 1282044.375*z;
	m8(3) = phi*(9.8100000000000005*m_aft_ps + 9.8100000000000005*m_aft_stb + 9.8100000000000005*m_fp_ps + 9.8100000000000005*m_fp_stb + 9.8100000000000005*m_payload + 594976.5)*(-3.8259206121472981e-6*m_aft_ps - 3.8259206121472981e-6*m_aft_stb - 3.8259206121472981e-6*m_fp_ps - 3.8259206121472981e-6*m_fp_stb + m_payload*wire_length/(m_aft_ps + m_aft_stb + m_fp_ps + m_fp_stb + m_payload + 60650) - 3.8259206121472981e-6*m_payload - 0.23204208512673363 - (m_aft_ps*(2 - 0.00048780487804878049*m_aft_ps) + m_aft_stb*(2 - 0.00048780487804878049*m_aft_stb) + m_fp_ps*(2 - 0.00048780487804878049*m_fp_ps) + m_fp_stb*(2 - 0.00048780487804878049*m_fp_stb) + m_payload*(-1.0*q4*sin(q2 + q3) - wire_length*(sin(q2_p)*sin(q2 + q3) - cos(q1_p)*cos(q2_p)*cos(q2 + q3)) - 2.0*sin(q2) - 1.2000000000000002*sin(q2 + q3) - 3.0) - 100.0*q4*sin(q2 + q3) - 200*(-1.0/2.0*q4 - 1.0/2.0)*sin(q2 + q3) - 600.0*sin(q2) - 140.0*sin(q2 + q3) + 133450.0)/(m_aft_ps + m_aft_stb + m_fp_ps + m_fp_stb + m_payload + 60650) - 341.66666666666663/(m_aft_ps + m_aft_stb + m_fp_ps + m_fp_stb + m_payload + 60650) + 767.65625/((1.0/1025.0)*m_aft_ps + (1.0/1025.0)*m_aft_stb + (1.0/1025.0)*m_fp_ps + (1.0/1025.0)*m_fp_stb + (1.0/1025.0)*m_payload + 2426.0/41.0));
	m8(4) = 10055.25*theta*((1.0/1025.0)*m_aft_ps + (1.0/1025.0)*m_aft_stb + (1.0/1025.0)*m_fp_ps + (1.0/1025.0)*m_fp_stb + (1.0/1025.0)*m_payload + 2426.0/41.0)*(-3.8259206121472981e-6*m_aft_ps - 3.8259206121472981e-6*m_aft_stb - 3.8259206121472981e-6*m_fp_ps - 3.8259206121472981e-6*m_fp_stb - 3.8259206121472981e-6*m_payload - 0.23204208512673363 - (m_aft_ps*(2 - 0.00048780487804878049*m_aft_ps) + m_aft_stb*(2 - 0.00048780487804878049*m_aft_stb) + m_fp_ps*(2 - 0.00048780487804878049*m_fp_ps) + m_fp_stb*(2 - 0.00048780487804878049*m_fp_stb) + m_payload*(-1.0*q4*sin(q2 + q3) - wire_length*(sin(q2_p)*sin(q2 + q3) - cos(q1_p)*cos(q2_p)*cos(q2 + q3)) - 2.0*sin(q2) - 1.2000000000000002*sin(q2 + q3) - 3.0) - 100.0*q4*sin(q2 + q3) - 200*(-1.0/2.0*q4 - 1.0/2.0)*sin(q2 + q3) - 600.0*sin(q2) - 140.0*sin(q2 + q3) + 133450.0)/(m_aft_ps + m_aft_stb + m_fp_ps + m_fp_stb + m_payload + 60650) + 2390.625/((1.0/1025.0)*m_aft_ps + (1.0/1025.0)*m_aft_stb + (1.0/1025.0)*m_fp_ps + (1.0/1025.0)*m_fp_stb + (1.0/1025.0)*m_payload + 2426.0/41.0));
	m8(5) = 0;
	m8(6) = 0;
	m8(7) = 0;
	return m8;
