...
Eigen::VectorXd model(Eigen::VectorXd kwargs) {
    ...
    Eigen::VectorXd q     = kwargs.segment(0, 8);
    Eigen::VectorXd p     = kwargs.segment(34, 8);
    ...
    Eigen::VectorXd dx = Eigen::VectorXd::Zero(42);
    dx.segment(0, 8) = dq;
    dx.segment(34, 8) = dp;
