...
Eigen::VectorXd D_q_dot(Eigen::VectorXd kwargs) {
	...
	Eigen::VectorXd m1(12, 1);
	m1(0) = 12964.523281596452*q + 6000*u;
	m1(1) = -21607.538802660754*p + 10000*v;
	m1(2) = 350000*w;
	m1(3) = 846688.57331084902*p - 21607.538802660754*v;
	m1(4) = 828013.14398650941*q + 12964.523281596452*u;
	m1(5) = 1500000*r;
	m1(6) = 20000*q1_dot;
	m1(7) = 20000*q2_dot;
	m1(8) = 20000*q3_dot;
	m1(9) = 20000*q4_dot;
	m1(10) = 3.1320919526731652*q1_pdot*sqrt(pow(m_payload, 2)/wire_length);
	m1(11) = 3.1320919526731652*q2_pdot*sqrt(pow(m_payload, 2)/wire_length);
	return m1;
}