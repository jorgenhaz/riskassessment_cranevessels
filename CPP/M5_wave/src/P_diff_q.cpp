...
Eigen::VectorXd P_diff_q(Eigen::VectorXd kwargs) {
	...
	double q3 = kwargs(32);
	double q4 = kwargs(33);
	Eigen::VectorXd m5(8, 1);
	m5(0) = 0;
	m5(1) = 0;
	m5(2) = -9.8100000000000005*m_aft_ps - 9.8100000000000005*m_aft_stb - 9.8100000000000005*m_fp_ps - 9.8100000000000005*m_fp_stb - 9.8100000000000005*m_payload - 594976.5;
